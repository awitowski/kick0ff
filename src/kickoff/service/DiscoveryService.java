...
import kickoff.dao.DiscoveryDAO;
...
public class DiscoveryService {
	 public void addDiscovery(String name, String desc, String url, User user) {
	    ...
	    public List<Discovery> getAllDiscoveriesByUsername(String username){
	    	DAOFactory factory = DAOFactory.getDAOFactory();
	        DiscoveryDAO discoveryDao = factory.getDiscoveryDAO();
	        List<Discovery> discoveriesByUsername = discoveryDao.getAll(username);
